...
1. `docs/usage-guide.md`
2. `docs/task-status.md`
3. `src/main/java/com/example/calculator/IterativeExpressionCalculator.java`
4. `src/main/java/com/example/calculator/IterativeExpressionEngine.java`
5. `src/main/java/com/example/calculator/IterativeBooleanExpressionEngine.java`
